...
for csv_file in csv_files:
    ...
    # Rimuovi le righe dove c'è solo accel==1 (mantieni solo righe con steer!=0 o brake!=0 o accel!=1)
    if 'steer' in df_clean.columns and 'brake' in df_clean.columns:
        mask = (df_clean['steer'] != 0) | (df_clean['brake'] != 0) | (df_clean['accel'] != 1)
